...
C
      ...
      CHARACTER*3 RECTYPE,MINFLAG(MAXELEM,MAXMONTHS),
     +            MAXFLAG(MAXELEM,MAXMONTHS),TYPEDEF(7)
      CHARACTER*2 RTNFLAG
...
C             .. DLY,SYN,HLY,OR 15M DATA
     ...
     +            MAXFLAG(NELEM,MONTH) = 'YES'
               IF (VALUE(J).EQ.MINVALUE(NELEM,MONTH)) 
     +            MINFLAG(NELEM,MONTH) = 'YES'
