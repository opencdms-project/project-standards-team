$STORAGE:2
      ...
      SUBROUTINE GETFRM(FORMNAME,HELPFILE,FIELD,FLDLEN,RTNFLAG)
C
...
C               OF THE GETLFRM SUBROUTINE.  IT IS IDENTICAL TO THIS 
C               ROUTINE EXCEPT IN IT MAXFLD = 90...  GETLFRM IS USED
