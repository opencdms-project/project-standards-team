...
C
     ...
     +       ,FORM='BINARY',ACCESS='DIRECT',RECL=43)
      DO 35 I = 1,9999
         READ(51,REC=I,ERR=40) INDESREC
         IF (INDESREC(1:8).EQ.SCRNNAME) THEN
            SCRNDESC = INDESREC(10:41)
            GOTO 40
         END IF
  35  CONTINUE
  40  CONTINUE
...
C
 ...
 45      OPEN (51,FILE='P:\FORM\FTNSCRN.IDX',STATUS='OLD'
     +       ,FORM='BINARY',ACCESS='DIRECT',RECL=43)
         DESCREC = ' '
