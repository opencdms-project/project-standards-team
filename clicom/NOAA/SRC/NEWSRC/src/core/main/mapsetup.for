...
C     PROGRAM MAPSETUP
C
C     ** OBJECTIVE:  THE PUPOSE OF THIS PROGRAM IS CONSTRUCTED A CALLMAP.BAT 
...
C
      ...
      DATA BLANK /' '/
C
      OPEN(51,FILE='C:\CALLMAP.BAT',STATUS='UNKNOWN',FORM='FORMATTED')
C
      CLICPRDR = BLANK
      CLIGRFDR = BLANK
C
...
C     THEN THE PROGRAM WILL WRITE INTO A BATCH FILE C:\CALLMAP.BAT.
