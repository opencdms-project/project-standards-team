...
C
C       ** OPEN THE FORTRAN FORM DEFINITION INDEX FILE TO RETRIEVE THE
C          DESCRIPTION OF THIS FORM IF THE FORM ALREADY EXISTS
C
      OPEN (51,FILE='P:\FORM\FTNFORM.IDX',STATUS='OLD'
     +       ,FORM='BINARY',ACCESS='DIRECT',RECL=43)
      DO 128 I = 1,9999
         READ(51,REC=I,ERR=135) INDESREC
         IF (INDESREC(1:8).EQ.FORMNAME) THEN
            FORMDESC = INDESREC(10:41)
            GOTO 135
         END IF
 128  CONTINUE
 135  CONTINUE
...
C
 ...
 138     OPEN (51,FILE='P:\FORM\FTNFORM.IDX',STATUS='OLD'
     +       ,FORM='BINARY',ACCESS='DIRECT',RECL=43)
         DESCREC = ' '
         CALL LOCATE(JROW,JCOL,JERR)
...
C
         CPYFLG = .TRUE.   
      ELSE IF (RTNFLAG.EQ.'2F'.OR.RTNFLAG.EQ.'RE') THEN   
         GO TO 129
      ELSE
         GO TO 125
      END IF
...
130   CONTINUE
     ...
     +    ,IOSTAT=IOCHK)
      IF (IOCHK.EQ.0) THEN
         ...
         READ(15) LINETYPE,BDRBG,BDRFG
$INCLUDE: 'RDFLDS.INC'
         CLOSE(15)
C
C       ** DETERMINE THE TYPE OF LINE:SINGLE, DOUBLE, SOLID OR BLANK LINES
C          TO SURROUND THE BOX.
C
         IF (LINETYPE.EQ.218) THEN
             BOXTYP = 1
         ELSE IF (LINETYPE.EQ.201) THEN
             BOXTYP = 2
         ELSE IF (LINETYPE.EQ.220) THEN
             BOXTYP = 3
         END IF
      ELSE
         NEWFRM = .TRUE.
         ...
         ELSE IF (INCHAR.EQ.'9F') THEN
            ...
            DO 400 J = 0,FRMHT-1
               DO 400 I = 0,FRMWID-1
                  ...
                  CALL RDCHAR(NCHAR(I+1,J+1),FBGCLR(I+1,J+1),
     +                  FFGCLR(I+1,J+1))
  400       CONTINUE
         ...
         ELSE IF (INCHAR.EQ.'DE') THEN
            ...
            ELSE IF (ICOL.LT.ENDCOL) THEN
               DO 420 I1 = ICOL+1, ENDCOL
                  ...
                  CALL RDCHAR(HLDCHR,HLDBGC,HLDFGC)
...
C
      DO 100 J = 0,FRMHT-1
         DO 100 I = 0,FRMWID-1
            CALL LOCATE(J,I,IERR)
            CALL RDCHAR(NCHAR(I+1,J+1),BGCOLOR(I+1,J+1),
     +                  FGCOLOR(I+1,J+1))
  100 CONTINUE
