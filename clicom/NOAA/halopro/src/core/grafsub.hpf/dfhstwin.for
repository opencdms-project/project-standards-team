...
C **END DEBUG         
      ...
      END       
**************************************************************************
      SUBROUTINE DFWINASP(STRING,IDFONT,ICLR,TXTHTND,
...
C **END DEBUG         
      ...
      CALL MAPWTD(XWLL,YWLL,IXDUL,IYDLR)
      CALL MAPWTD(XWLL+WIDSTR,YWLL+HEIGHT,IXD,IYD)
         IWIDSTR = MAX0(IXD-IXDUL,1)
         FAC = 1.0
         CALL MAPNTD(XNDLR-XTRA_X,YNDLR,IXDLR,IYDLR)
         WINASP = ADJASP *(FAC*ABS(IXDLR-IXDUL)/REAL(IWIDSTR))
C **DEBUG         
         WRITE(999,*)'XNDUL,YNDUL,XNDLR,YNDLR=',XNDUL,YNDUL,XNDLR,YNDLR
         WRITE(999,*)'XWLL,YWLL,XWUR,YWUR=',XWLL,YWLL,XWUR,YWUR
         WRITE(999,*)'IXDLR,XTRA_X=',IXDLR,XTRA_X
         WRITE(999,*)'STRING,HEIGHT,OFFSET,WID=',
     +                STRING,HEIGHT,OFFSET,WIDSTR
         WRITE(999,*)'WINASP,IXDUL,IXD,IWSTR=',
     +                WINASP,IXDUL,IXD,IWIDSTR
         CALL MAPWTD(XWLL,YWLL,IXDUL,IYDLR)
         CALL MAPWTD(XWUR,YWLL,IXDLR,IYDLR)
         WRITE(999,*)'WTD  IXDUL,IXDLR=',IXDUL,IXDLR
         CALL MAPNTD(XNDUL,YNDUL,IXDUL,IYD)
         CALL MAPNTD(XNDLR,YNDUL,IXDLR,IYD)
         WRITE(999,*)'NTD  IXDUL,IXDLR=',IXDUL,IXDLR
C
