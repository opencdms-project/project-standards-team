...
C **DEBUG
        WRITE(999,*)'DRWTXT--HT,WID=',HEIGHT,WIDTH      
C          
...
C **DEBUG
        WRITE(999,*)'DEFHST--TXTHTNW,XHTW,YHTW=',TXTHTNW,XHTW,YHTW
      NIANG = NINT(ANG)
...
C**END DEBUG 3-29-94
C **DEBUG
      WRITE(999,*)'##DEFHST-- DEV/INQ/SCR ASP=',DEVASP,DASPINQ,SCRNASP
        WRITE(999,*)'######DEFHST-- ASP,TXTASP,VASP=',ASP,TXTASP,VASP
C **DEBUG 3-29-94
...
C **DEBUG 3-30-94      
      YHTW = (YW-YW1)/DEVASP
C      
C      CALL INQWOR(XW1,YW1,XW2,YW2)
C      YHTW = TXTHTNW*ABS(YW2-YW1)
C      CALL CURASP(TXTASP,ASP)
      WRITE(999,*)'DEFHST--XND1,YND1,XND2,YND2=',XND1,YND1,XND2,YND2 
      WRITE(999,*)'DEFHST--XW1,YW1,XW2,YW2=',XW1,YW1,XW2,YW2
      WRITE(999,*)'DEFHST--SETSTE-YHTW,ASP=',YHTW,ASP
C **END DEBUG 3-29-94              
C      
      IPATH = 0
      CALL SETLNW(1)
