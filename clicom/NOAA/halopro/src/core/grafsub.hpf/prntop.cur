...
$INCLUDE: 'HALOENV.INC'
      ...
      INTEGER      PTRINQ(60), PTRSUP(0:63), WIDE, HLPLVL, WIDTH, HGT,
...
C ----   GET PRIMARY & ALTERNATE TITLES FROM MESSAGE FILE
      ...
      ELSE
         PRFLDS(1)=ALTRNT
      ENDIF
      CALL SETPRN(PRINTR(IDPTR))
      FORMID   = 'HALOPRN1'
      ENGLUNIT = USCALE .EQ. 1.00
C
...
C **DEBUG
C        DO 9999 I=1,40
C9999    WRITE(9998,*) I-1,PTRSUP(I-1),I,PTRINQ(I)      
C **END DEBUG
      HLPLVL = 1
      IF (DPI .EQ. -1) THEN
         MODE = PTRINQ(3)
...
C
            ...
            IF (YN .EQ. YESUP .OR. YN .EQ. YESLO) THEN
               ...
               WRITE(44,700) DEVICE,DEVMODE,AQCMODE,NETWORK,
